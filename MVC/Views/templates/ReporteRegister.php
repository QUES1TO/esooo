...
<form class="col-6" action="create" method="POST" enctype="multipart/form-data">
        <div class="mb-3 col-12">
            ...
            <input class="miInput form-control" type="text" id="fname" name="Tipo" placeholder="Tipo">
            ...
            <label class="form-label" for="fname">Empleado</label>
            <input class="miInput form-control" type="text" id="fname" name="Empleado" placeholder="Empleado">
